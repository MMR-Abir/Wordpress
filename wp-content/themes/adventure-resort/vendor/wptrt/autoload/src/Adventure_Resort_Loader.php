...
class Adventure_Resort_Loader {
	 ...
	 * @return void
	 */
	public function adventure_resort_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function adventure_resort_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function adventure_resort_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function adventure_resort_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->adventure_resort_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function adventure_resort_load( $class ) {
