...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-trekking');?>
        
        
        <?php if( is_home() && is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/');?>" target="_blank"><?php esc_html_e('SKT Themes','skt-trekking'); ?></a>
        <?php } else {?>
          <?php esc_html_e('SKT Themes','skt-trekking'); ?>
        <?php } ?>
        </div>
     <div class="clear"></div>
</div>           
